...
echo __( 'Someone requested that the password be reset for the following account:', 'oseo' ) . "\r\n\r\n";
echo esc_url( network_home_url( '/' ) ) . "\r\n\r\n";
echo sprintf( __( 'Username: %s', 'oseo' ), $user_login ) . "\r\n\r\n";
echo __( 'If this was a mistake, just ignore this email and nothing will happen.', 'oseo' ) . "\r\n\r\n";
echo __( 'To reset your password, visit the following address:', 'oseo' ) . "\r\n\r\n";
