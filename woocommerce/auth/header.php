...
<head>
	...
	<title><?php _e( 'Application Authentication Request', 'oseo' ); ?></title>
...
<body class="wc-auth wp-core-ui">
	<h1 id="wc-logo"><img src="<?php echo get_template_directory_uri().'/img/logo.png';?>" alt="<?php echo get_bloginfo('name');?>" /></h1>
